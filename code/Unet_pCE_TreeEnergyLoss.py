...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            elif args.model == 'unet_multihead':
            ...
            logging.info(
                'iteration %d : loss : %f, loss_ce: %f, TreeEnergyLoss: %f' %
            ...
            if iter_num % 10 == 0:
                ...
                for i in range(args.num_classes):
                    heatmap = heatmaps[0, i, :, :].detach().unsqueeze(0)
                ...
                if args.img_class == 'odoc':
                    writer.add_image('train/Heatedmap1_Cup', heatmap_num[1], iter_num,dataformats='CHW')
                    writer.add_image('train/Heatedmap2_Disc', heatmap_num[2], iter_num,dataformats='CHW')
                if args.img_class == 'faz' or args.img_class == 'polyp':
                    writer.add_image('train/Heatedmap', heatmap_num[1], iter_num,dataformats='CHW')
