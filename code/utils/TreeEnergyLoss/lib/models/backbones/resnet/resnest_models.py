...
class ResNeSt(nn.Module):
    ...
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64,
                 ...
                 last_gamma=False, bn_type=None, in_chns=3):
        self.cardinality = groups
        ...
        if deep_stem:
            self.conv1 = nn.Sequential(
                conv_layer(in_chns, stem_width, kernel_size=3, stride=2, padding=1, bias=False, **conv_kwargs),
            ...
            self.conv1 = conv_layer(in_chns, 64, kernel_size=7, stride=2, padding=3,
